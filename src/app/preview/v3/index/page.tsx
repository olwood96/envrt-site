...
// Reviewer index for /preview/v3/. Lists every v3 surface so reviewers
// can scan the full build at a glance. The real homepage now lives at
// /preview/v3 (root), so this page is the secondary "sitemap" view.
...
const SHIPPED = [
  {
    href: "/preview/v3",
    label: "Homepage",
    note: "The full v3 homepage, now the root of /preview/v3",
  },
    ...
    <main className="relative bg-envrt-brand-vista">
      ...
      <div className="mx-auto max-w-[1280px] px-5 py-20 sm:px-8 sm:py-28 lg:px-16 lg:py-32">
        ...
        <p className="mt-5 max-w-2xl text-base leading-relaxed text-envrt-brand-black/70 sm:text-lg">
          The homepage is now at the root. This page lists every other
          surface in the v3 build for reviewers. The live site at the
          root is untouched until v3 is approved.
        </p>
