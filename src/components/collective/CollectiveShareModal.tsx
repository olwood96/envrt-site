...
interface Props {
  ...
  /** Snippet brands paste on their site: <a> link + <script> that opens the
      DPP in a popup iframe via envrt.com/embed.js. This is per-garment —
      the SKU is hardcoded so the brand pastes a different snippet for each
      product. */
  popupSnippet: string;
}
                ...
                {shopifyHelpOpen && (
                  <div className="mt-3 space-y-3 text-[10px] leading-relaxed text-envrt-charcoal">
                    <p className="text-envrt-muted">
                      You&apos;ll do this once per product. The snippet above
                      is specific to{" "}
                      <strong className="text-envrt-charcoal">
                        {productName}
                      </strong>{" "}
                      &mdash; open each garment&apos;s DPP page on ENVRT to
                      grab its own snippet.
                    </p>
                    <ol className="list-inside list-decimal space-y-1.5 text-envrt-muted [&_strong]:text-envrt-charcoal">
                      ...
                      <li>
                        ...
                        <strong>Products</strong> and open the product that
                        matches this garment.
                      </li>
                      <li>
                        In the <strong>Description</strong> field, click{" "}
                        <strong>&lt;&gt;</strong> to switch to HTML view.
                      </li>
                      <li>
                        Paste the snippet above at the end of the description.
                      </li>
                      <li>
                    ...
                    <p className="text-envrt-muted">
                      <strong className="text-envrt-charcoal">
                        Cleaner option (Focal theme editor):
                      </strong>{" "}
                      open <strong>Online Store &rarr; Themes &rarr;
                      Customize</strong>, navigate to this specific product
                      via the top dropdown, then add a{" "}
                      <strong>Custom Liquid</strong> block and paste the
                      snippet there. Keeps the description clean and lets you
                      place the link anywhere on the page.
                    </p>
                  </div>
                )}
              </div>
