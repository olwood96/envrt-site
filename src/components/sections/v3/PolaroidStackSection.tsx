...
const POLAROIDS: Polaroid[] = [
  {
    ...
    alt: "Natural linen weave, raw fibre",
    finalRotate: -10,
    finalX: -120,
    finalY: -10,
    cumCo2Kg: 0.48,
  ...
  },
  {
    ...
    alt: "Stacked bolts of folded fabric in a tailor's workshop",
    finalRotate: 0,
    finalX: 0,
    finalY: 0,
    cumCo2Kg: 7.05,
  ...
  },
  {
    ...
    src: "/v3-assets/angry-pablo-tagged.jpg",
    alt: "Angry Pablo jersey with its ENVRT digital product passport hangtag",
    finalRotate: 11,
    finalX: 120,
    finalY: -8,
    cumCo2Kg: 7.45,
