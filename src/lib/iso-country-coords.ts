/**
 * ISO 3166-1 alpha-2 country codes → approximate centroid coordinates.
 * Used by the impact tracker map to plot DPP scan locations.
 */
export const ISO_COORDS: Record<string, { lat: number; lng: number }> = {
  AD: { lat: 42.55, lng: 1.52 },
