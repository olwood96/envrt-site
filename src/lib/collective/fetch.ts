...
const DPP_LIST_FIELDS =
  "id, brand_id, collection_name, product_sku, garment_name, garment_mass_g, garment_type, transparency_score, total_emissions, total_water, total_emissions_reduction_pct, total_water_reduction_pct, constituents, image_path, featured_at, purchase_url, display_options, version";

const DPP_DETAIL_FIELDS =
  "id, brand_id, collection_name, product_sku, garment_name, garment_mass_g, garment_type, transparency_score, total_emissions, total_water, total_emissions_reduction_pct, total_water_reduction_pct, constituents, image_path, featured_at, purchase_url, display_options";
