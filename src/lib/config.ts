...
export const teamMembers = [
  {
    ...
    role: "Co-Founder & CEO",
    bio: "Background in sustainable fashion and brand strategy.",
    image: "/team/charles.jpg",
  },
  {
    name: "Oliver",
    role: "Co-Founder & CTO",
    bio: "Astrophysics background. Leads technical development.",
    image: "/team/oliver.jpg",
  },
  {
    name: "Dr. Edward Hirst",
    role: "AI Advisor",
    bio: "AI research and applied machine learning.",
    image: "/team/edward.jpg",
  },
  {
    name: "Dr. Matthew Cheng",
    role: "AI Advisor",
    bio: "Data science and environmental modelling.",
