...
draft: false
faq:
  - question: "Can I call my product sustainable?"
    answer: "Under the EU Green Claims Directive, generic terms like 'sustainable' or 'eco-friendly' will need to be backed by verified, product-level performance data using a recognised methodology. Without that evidence, the claim carries regulatory risk."
  - question: "What counts as substantiation for a green claim?"
    answer: "Product-level evidence using a recognised methodology such as ISO 14040 LCA, covering the specific product and component the claim refers to. The evidence must be current, documented and producible when asked."
---
...
Most [greenwashing](/insights/greenwashing-in-fashion) exposure in fashion does not come from deliberate deception. It comes from a workflow problem: marketing copy is written first, and proof is assembled afterward.
