...
draft: false
faq:
  - question: "What is the difference between cradle-to-gate and cradle-to-grave LCA?"
    answer: "Cradle-to-gate covers raw material extraction through to the finished product leaving the factory. Cradle-to-grave extends to include consumer use and end-of-life disposal. Cradle-to-gate is the most common scope in fashion because it captures the bulk of supply chain impacts."
  - question: "Do I need primary supplier data to run an LCA?"
    answer: "Not necessarily to get started. Industry databases provide credible secondary data for common materials and processes. The goal is to progressively improve data quality by replacing database averages with supplier-specific inputs over time."
  - question: "Is an LCA the same as a carbon footprint?"
    answer: "A carbon footprint is one output of an LCA, covering climate change only. A full LCA can assess multiple impact categories including water use, acidification, resource depletion and others. The EU PEF method requires assessment across 16 categories."
---
...
The methodology is governed by ISO 14040 and ISO 14044, which set out a consistent framework for how studies should be defined, built, and interpreted. That standardisation provides the consistent framework needed for credible, structured assessment, and is what separates a proper LCA from a back-of-the-envelope carbon estimate.
...
Inventory quality is usually the limiting factor in fashion. [Supplier data](/insights/supply-chain-intelligence-turning-data-into-action) can be partial, inconsistent, held across multiple spreadsheets, or simply unavailable at the detail required. Closing these gaps without making assumptions that undermine the results is where a significant part of the effort lives.
...
Starting early also means starting better, because the quality of your LCA improves as your supplier data matures. The [commercial case for building this capability](/insights/business-case-sustainability-data-fashion) extends well beyond compliance, and strengthens the earlier a brand starts.
