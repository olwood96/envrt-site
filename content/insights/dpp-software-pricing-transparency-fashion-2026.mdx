...
faq:
  ...
  - question: "How much does Digital Product Passport software cost for fashion brands?"
    answer: "Published pricing ranges from ENVRT's €249 per month (around €2,990 per year) entry tier to tex.tracer's €15,000 Medium tier. Quote-on-request vendors fall within the €15,000 to €100,000+ range that Renoon's own January 2026 market analysis defines as mid-market DPP."
...
**ENVRT** publishes an entry tier at €249 per month (around €2,990 per year). The licence includes Life Cycle Assessment, supply chain traceability and Digital Product Passport rendering natively, with no add-on modules required for these capabilities.
