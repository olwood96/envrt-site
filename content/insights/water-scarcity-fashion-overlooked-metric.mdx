...
description: "Carbon dominates fashion's sustainability conversation, but water scarcity is causing acute harm in production regions. This guide explains why brands should be measuring it and how the AWARE method works."
date: "2026-04-18"
author: "ENVRT"
...
Fashion's sustainability conversation is dominated by carbon. Climate targets, carbon footprints, Scope 3 emissions and net zero commitments take up the majority of boardroom time and column inches. Carbon matters, and it should be measured and reduced. But for a significant share of fashion products, the environmental impact that receives the least attention is the one causing the most acute harm in the regions where garments are actually made.
...
**Regulatory frameworks are multi-indicator.** The EU PEF methodology includes water use as one of its 16 impact categories and it is consistently identified as one of the most relevant for apparel. The [Digital Product Passport](/insights/digital-product-passport-textiles-guide) is expected to include water-related indicators. CSRD reporting under ESRS E3 requires disclosure on water consumption and water stress exposure. A carbon-only approach will not satisfy these requirements.
