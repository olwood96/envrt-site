...
draft: false
faq:
  - question: "Is transport the biggest source of emissions for fashion?"
    answer: "For most garments shipped by sea, transport accounts for just 3-8% of total climate impact. The stages upstream, particularly fibre production and wet processing, typically drive far larger shares of environmental impact."
  - question: "Are sustainability hotspots the same for every garment?"
    answer: "No. Hotspots shift depending on fibre mix, fabric weight, production geography and assessment scope. Two products in the same collection can have completely different environmental profiles."
---
...
At ENVRT, hotspot identification is built into the output of every assessment run through ENVRT LAB™. Rather than presenting a single footprint number, ENVRT generates climate impact (CO₂e) and water scarcity impact at the product level on a [cradle-to-gate basis](/insights/life-cycle-assessment-guide-for-brands), giving brands a clear view of where impacts are largest across both dimensions.
