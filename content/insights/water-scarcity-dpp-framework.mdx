...
description: "The EU's DPP data specification methodology confirms water use is one of the most relevant impact categories for apparel. Carbon-only measurement will not satisfy the multi-indicator requirements the DPP framework is building toward."
date: "2026-05-05"
author: "ENVRT"
tags: ["Water", "DPP", "LCA"]
...
faq:
  - question: "Does the EU DPP require water impact data for textiles?"
    answer: "The PEF framework identifies water use as one of the most relevant impact categories for apparel. The DPP data specification methodology confirms this. A carbon-only approach will not satisfy multi-indicator regulatory requirements."
